...
{
tau_phi = I_xx*(control_siso(phi_r, phi, p, kp_theta_phi, kd_theta_phi)) ;
tau_theta = I_yy*(control_siso(theta_r, theta, q, kp_theta_phi, kd_theta_phi)) ;
...
{
    return kp*(angle_r-angle)+kd*(rate) ;  // derivada do angulo_r?
}