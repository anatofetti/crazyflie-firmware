...
const float wc_range = 10.0; //rad/s
const float zeta_range = sqrt(2.0)/2.0;
const float l1 = wc_range*wc_range;
const float l2 = 2.0*zeta_range*wc_range;

// Lab 10
const float Ts_ver = 2.0; //segundos
const float OS_ver = 0.003; //0.5%
...
const float wc_flow = 50.0;

//Lab 12
const float Ts_hor = 2.0; //segundos
const float OS_hor = 0.003; //0.5%
...
const float h = 0.5; //m
const float ts = 1.5; //s
const float tp = 2.0; //s
const float tv = 6.0; //s
const float td = 3.0; //s
const float dx = 1.4; //m
const float dy = -0.2; //m
